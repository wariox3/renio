...
export const locale = {
  ...
  data: {
    ...
    LANGINGPAGE: {
      ...
      APPAUTENTICA: 'Disfruta de la aplicación Nautica',
      ...
      NUESTROEQUIPOFRESE1: 'No hay duda de que cuando  un desarollo trarda más en completarse,',
      NUESTROEQUIPOFRESE2: 'los costos, adicionales para ingresar y probar cada caracteristica adicional se arrastran y nmos oersiguen a la mayoria de nosotros',
      NUESTROSPROYECTOS: 'Nuestro proyecto',
      NUESTROSPROYECTOS1: 'Ultimo',
      NUESTROSPROYECTOS2: 'Diseño de paginas web',
      NUESTROSPROYECTOS3: 'Aplicaciones  moviles',
