...
export class ProgramacionService extends Subdominio {
  ...
  guardarProgramacion(data: any) {
    return this.httpService.post<ProgramacionRespuesta>(`humano/programacion/`, data);
  }

  consultarDetalle(id: number) {
    return this.httpService.getDetalle<ProgramacionRespuesta>(`humano/programacion/${id}/`);
  }

  actualizarDatosProgramacion(id: number, data: any) {
    return this.httpService.put<ProgramacionRespuesta>(`humano/programacion/${id}/`, data);
  }
