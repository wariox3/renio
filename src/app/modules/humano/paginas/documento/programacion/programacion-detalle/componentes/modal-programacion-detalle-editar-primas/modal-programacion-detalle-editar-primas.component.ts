...
@Component({
  selector: 'app-modal-programacion-detalle-editar-primas',
  standalone: true,
  imports: [CommonModule, TranslateModule, FormsModule, ReactiveFormsModule],
  templateUrl: './modal-programacion-detalle-editar-primas.component.html',
})
export class ModalProgramacionDetalleEditarCesantiasComponent extends General {
  ...
  iniciarFormularioEditarDetalles() {
    ...
    if (this.pagoTipoId === 2) {
      formConfig.prima_propuesto = [0, Validators.required];
    }
      ...
      .subscribe((respuesta) => {
        if (respuesta.results.length) {
          ...
          if (
            ...
            patchData.prima_propuesto = registro.prima_propuesto || 0;
          } 
          {
