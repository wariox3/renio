    ...
    this.httpService
      ...
      .subscribe((respuesta) => {
        ...
        this.arrDocumentos = respuesta.registros?.map((documento) => ({
          ...
          documento__contacto__numero_identificacion:  documento.documento_contacto_numero_identificacion,
          documento__contacto__nombre_corto: documento.documento_contacto_nombre,
