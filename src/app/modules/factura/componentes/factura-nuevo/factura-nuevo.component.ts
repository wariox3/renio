  ...
  agregarItemSeleccionado(item: any, index: number) {
    ...
    if (item.impuestos) {
      item.impuestos.map((impuesto: any) => {
        ...
        delete impuesto['impuesto_compra'];
        delete impuesto['impuesto_venta'];
        delete impuesto['impuesto_porcentaje'];
        delete impuesto['impuesto_id'];
