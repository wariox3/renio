...
@Component({
  selector: 'app-remision-formulario',
  standalone: true,
  templateUrl: './remision-formulario.component.html',
  styleUrls: ['./remision-formulario.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export default class RemisionFormularioComponent
  extends General
  implements OnInit, OnDestroy
{
  ...
  private _esValidaLogicaDeFacturacion(): boolean {
    if (this.totalPago.value > this.totalGeneral.value) {
      this.alertaService.mensajeError(
        'Error',
