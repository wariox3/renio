...
@Component({
  selector: 'app-factura-pos-detalle',
  standalone: true,
  templateUrl: './factura-pos-electronica-detalle.component.html',
  styleUrls: ['./factura-pos-electronica-detalle.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export default class FacturaPosDetalleComponent extends General {
  active: Number;
  documento: any = {
    contacto_id: '',
    descuento: '',
