...
@Component({
  selector: 'app-translado-detalle',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './translado-detalle.component.html',
  styleUrls: ['./translado-detalle.component.scss']

})
export default class TransladoDetalleComponent extends General {
  active: Number;
  documento: any = {
    contacto_id: '',
    descuento: '',
